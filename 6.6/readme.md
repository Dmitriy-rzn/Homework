...
4.  
```
Когда у сервера или процесса заканчивается память, Linux предлагает 2 пути решения: обрушить всю систему или завершить процесс (приложение), который съедает память, дабы не допустить падение всего сервера, 
завершается процесс, для решения можно попробовать:
